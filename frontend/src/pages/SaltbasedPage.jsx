...
const SaltbasedPage = () => {
  ...
  const lph100Products = products.filter((p) => p.lph100OnNav);
    ...
    <div className="pt-1 mt-2 min-h-screen bg-linear-to-br from-green-50 via-white to-green-100">
        ...
        <div className="max-w-9xl mx-auto grid md:grid-cols-2 items-center gap-10 bg-linear-to-r from-purple-800 to-indigo-200 rounded-3xl p-8 md:p-12 shadow-xl">
          <div>
            <h1 className="text-4xl md:text-4xl text-white leading-tight">
              SaltBased
              <span className="text-purple-200">Softeners</span>
            </h1>
            ...
            <p className="mt-4 text-white/80 text-lg">
              Discover our premium water Softeners with advanced German
              filtration Technology, mineral retention, your favoruite Sleek and
              modern design.
            </p>
          </div>
      ...
      <section className="px-6 md:px-16 py-12">
        <h2 className="text-2xl text-center font-semibold mb-1 text-gray-800">
          Yukkon's Water Softeners
        </h2>

        <div className="grid md:grid-cols-3 gap-8">
          {lph100Products.map((item, index) => (
            <div
              key={index}
      ...
      <section className="px-6 md:px-16 py-12 bg-white">
        <h2 className="text-2xl font-semibold text-gray-800 mb-6">
          Why Choose Salt Based Water Softeners?
        </h2>
